  ...
  return (
    <div className="home-wrapper">
      <div className="home-main">
        <Lottie loop animationData={doMyBestJson} play style={{ width: '50%', height: '50%' }} />
        <div>
      ...
      <div className="home-main">
        <Lottie loop animationData={everyExperienceJson} play style={{ width: '50%', height: '50%' }} />
        <div>
      ...
      <div className="home-sub">
        ...
        <div>
          <p className="intro-black">
            ...
            저는 이외에 넓고 우호적인 인간관계, 여러 사람들에게 인정받을 수 있는 능력, 그리고 여유를 가질 수 있는 심적인
            부분 등의 방면에서 부유한 사람이 되고자 합니다. 이러한 점들을 먼저 증식시키면 재력에 대한 부유함은 저절로
            따라오게 될 것이라고 생각합니다.
          </p>
          <p className="intro-black">
            &nbsp; 제 인생의 모토는 가장 중요한 것은 사람이라는 것입니다. 안락한 삶을 영위할 수 있다 하더라도, 결국 이를
            함께 나눌 수 있는 사람이 중요하다는 것을 중요시 하고 있습니다. 따라서, 한 사람마다의 인연을 헛되이 하지
            않으며 조직의 원만한 분위기를 위해 노력하고 있습니다. 좋은 환경과 양질의 업무를 함께 만들어가는, 그리고
            조직에 꼭 필요한 사람이 되고자 합니다.
          </p>
        </div>
      </div>
    </div>
